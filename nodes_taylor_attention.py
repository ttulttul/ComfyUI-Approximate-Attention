    ...
    def define_schema(cls) -> io.Schema:
        return io.Schema(
            ...
            inputs=[
                ...
                io.Int.Input("max_feature_dim_R", default=400000, min=1, max=500000, step=1, tooltip="Safety cap for feature dimension R."),
                ...
                io.Int.Input("sub_head_blocks", default=1, min=1, max=16, step=1, tooltip="Split each head into sub-blocks to reduce feature dimension."),
                ...
                io.Boolean.Input("memory_reserve_log", default=False, tooltip="Log reserved VRAM estimates."),
                io.Boolean.Input("early_probe", default=False, tooltip="Probe denominators before full Taylor compute."),
                io.Int.Input("probe_samples", default=8, min=1, max=64, step=1, tooltip="Queries sampled for early probe."),
                io.Boolean.Input("denom_fp32", default=False, tooltip="Compute denominators in fp32 for stability."),
                io.Boolean.Input("quality_check", default=False, tooltip="Log a sampled accuracy check vs softmax."),
                io.Int.Input("quality_check_samples", default=8, min=1, max=64, step=1, tooltip="Number of sampled queries per call."),
